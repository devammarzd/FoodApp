...
class NearbyRestWidget extends StatelessWidget {
  ...
  NearbyRestWidget({@required this.name,@required this.image,@required this.rating,@required this.time,@required this.details});
  @override
    ...
    return           Container(
                    ...
                    child: Padding(
                      ...
                      child: Card(
                        ...
                        context,
                        MaterialPageRoute(
                            builder: (context) => RestProfileScreen()),
                      );
                        },
                                                      child: Container(
